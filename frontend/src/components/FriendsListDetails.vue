<template>
    <div class="
        ...
        <div class="details-status">
            <IconFriendHeart height="20px" /> Wants to be friends
        </div>
...
.friends-list-details {
    ...
    --shdw-etc: 
        inset  0    0   0 9px var(--col-lt-gray-4),
        inset  0    0   0 9px var(--col-lt-gray-4);
...
.details-username {
    ...
    filter: drop-shadow(var(--shadow-dist-m) var(--shadow-dist-m) var(--col-shadow-alpha));
    ...
    &::before { order: 0; border-right: var(--border-s); }
    &::after  { order: 1; border-left:  var(--border-s); }
}
