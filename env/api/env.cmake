...
if(NOT DEFINED GECKO_API_DOMAIN_ROOT)
    message(FATAL_ERROR "Domain root wasn't specific (-DGECKO_API_DOMAIN_ROOT)")
elseif(NOT DEFINED GECKO_API_BACKEND_ORIGIN)
    message(FATAL_ERROR "Backend origin wasn't specific (-DGECKO_API_BACKEND_ORIGIN)")
elseif(NOT DEFINED GECKO_API_FRONTEND_ORIGIN)
    message(FATAL_ERROR "Frontend origin wasn't specific (-DGECKO_API_FRONTEND_ORIGIN)")
...
message("GECKO_API_DOMAIN_ROOT:                  ${GECKO_API_DOMAIN_ROOT}")
message("GECKO_API_BACKEND_ORIGIN:               ${GECKO_API_BACKEND_ORIGIN}")
message("GECKO_API_FRONTEND_ORIGIN:              ${GECKO_API_FRONTEND_ORIGIN}")
